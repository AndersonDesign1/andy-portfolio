  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          I&apos;m really looking forward to working on your project and helping
          you get your business or idea online.
        </Text>
        ...
        <Section style={box}>
          ...
          {/* Replace with the live WhatsApp number before re-enabling. */}
          <Link href="https://wa.me/2348123456789" style={button}>
