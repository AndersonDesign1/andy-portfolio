...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md font-medium text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-light-heading text-light-bg hover:opacity-90 dark:bg-dark-heading dark:text-dark-bg",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border border-light-mini/20 bg-light-bg text-light-heading hover:bg-light-mini/5 dark:border-dark-mini/20 dark:bg-dark-bg dark:text-dark-heading dark:hover:bg-dark-mini/5",
        secondary:
