...
export const projects = [
  ...
  },
  {
    id: 3,
    name: "PromptEarn",
    description: "Implemented advanced SEO strategies that increased organic search visibility, boosting monthly organic traffic by 250% within six months. Optimized Google Core Web Vitals and PageSpeed scores, reducing bounce rates by 50%.",
    category: "SEO",
  ...
  },
  {
    id: 4,
    name: "BookTutors",
    description: "Achieved top 3 Google rankings for multiple pages, resulting in a 70% increase in organic traffic and a 35% rise in course sign-ups within six months through targeted keyword research and strategic content optimization.",
    category: "SEO",
